...
setwd("D:\\MSIS\\sem4\\DE\\project\\Datasets\\Data\\")
...
revenue_data <- read.xlsx("statistic_id540128_alphabet_-quarterly-revenue-2014-2020.xlsx", sheetIndex = 2, startRow = 5)
...
revenue_data <- read.xlsx("statistic_id273963_amazon_-quarterly-net-revenue-2007-2020.xlsx", sheetIndex = 2, startRow = 5)

amazon_revenue <- readRevenueDataCompanyWise(revenue_data,"AMZN",FALSE)

revenue_data <- read.xlsx("statistic_id422035_facebook_-worldwide-quarterly-revenue-2011-2020.xlsx", sheetIndex = 2, startRow = 5)

facebook_revenue <- readRevenueDataCompanyWise(revenue_data,"FB",TRUE)

final_data <- alphabet_revenue #rbind(alphabet_revenue,apple_revenue)
